 ...
 * {@link sitio1.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link sitio1#newInstance} factory method to
 * create an instance of this fragment.
 */
public class sitio1 extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener, GoogleMap.OnMarkerDragListener {
    ...
    public static sitio1 newInstance(String param1, String param2) {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng paso4 = new LatLng(  5.757770, -72.907170);
        Polyline line = googleMap.addPolyline(new PolylineOptions()
                .add(Bogota,paso1,paso2,paso3,paso4,sitio3)
                .width(5)
                .color(Color.RED));
