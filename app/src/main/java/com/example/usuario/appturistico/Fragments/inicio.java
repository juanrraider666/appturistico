...
import com.example.usuario.appturistico.sitios;
 ...
 */
public class inicio extends Fragment implements comunicacion, com.example.usuario.appturistico.sitios.OnFragmentInteractionListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     v =   inflater.inflate(R.layout.fragment_inicio, container, false);
        ...
        getFragmentManager().beginTransaction().replace(R.id.fragmentcontenido , sitios).commit();*/
    ...
    public void enviarsitio(extracciondesitios extracciondesitios) {
        ...
        assert getFragmentManager() != null;
        fragmentdetalle = (Fragmentdetalle) getFragmentManager().findFragmentById(R.id.detallelista);
        if(fragmentdetalle != null && v.findViewById(R.id.fragmentcontenido)==null){
            ...
            assert getFragmentManager() != null;
            getFragmentManager().beginTransaction().replace(R.id.fragmentcontenido, fragmentdetalle).addToBackStack(null).commit();
